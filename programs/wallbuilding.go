...
// move these out of lib and declare them wherever used;
// any func with more than 1 blocking turtle operation needs to be split up
...
func Wallbuildfunc(t turtle.Turtle) {
